...
if __name__ == '__main__':
    ...
    model_path = [os.path.join(root_dir, '../models/PNet_1/PNet-60'), 
                  ...
                  # os.path.join(root_dir, '../models/LONet_wflw_finetune1/LONet-537'),
                  os.path.join(root_dir, '../models/LONet_wflw_98_L94/LONet-52'),
                  # os.path.join(root_dir, '../models/LONet_0805/LONet-340'),
                  ]
    image_path = os.path.join(root_dir, '../image_test/')
    result_path=os.path.join(root_dir,'../xuhua_result_data/LONet_wflw_98_L48/LONet-1687/expand0.3/')
