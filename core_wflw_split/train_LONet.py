...
base_dir = os.path.join(root_dir, '../data/train_data/wflw_98_L94/imglists/LONet')
model_path = os.path.join(root_dir, '../models/LONet_wflw_98_L94/LONet')
logs_dir = os.path.join(root_dir, '../models/logs/LONet_wflw_98_L94')
# pre_model_path = os.path.join(root_dir, '../models/LONet_wflw_finetune_1/LONet-1600')
# pre_model_path = os.path.join(root_dir, '../models/LONet_wflw_98_L48/LONet-1702')
...
# LR_EPOCH = [2000,2100,2300,2600,2900,3200,3500,3800,4100] 
...
loss = ratio_cls_loss*cls_loss_op + ratio_bbox_loss*bbox_loss_op \
     + ratio_eye_loss*eye_loss_op +ratio_eyebrow_loss*eye_loss_op +ratio_mouth_loss*mouth_loss_op+ratio_multi_loss*multi_loss_op \
     + L2_loss_op
