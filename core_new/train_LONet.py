...
base_dir = os.path.join(root_dir, '../data/training_data/L48/imglists/LONet')
model_path = os.path.join(root_dir, '../models/LONet_finetune/LONet')
logs_dir = os.path.join(root_dir, '../models/logs/LONet_finetune')
pre_model_path = os.path.join(root_dir, '../models/LONet_1/LONet-3820')
...
LR_EPOCH = [1000,4000,10000,30000,60000,100000,200000,500000,1000000]
