...
base_dir = os.path.join(root_dir, '../data/training_data/L48_wflw/imglists/LONet')
model_path = os.path.join(root_dir, '../models/LONet_wflw_finetune_2/LONet')
logs_dir = os.path.join(root_dir, '../models/logs/LONet_wflw_finetune_2')
...
MULTIPLE=1
LR_EPOCH = [10,40,100,300,600,1000,2000,5000,10000] *MULTIPLE
