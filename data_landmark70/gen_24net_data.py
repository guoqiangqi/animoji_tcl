...
from detection_py import detect_pnet
...
if __name__ == '__main__':
    debug = True
    image_size = 24
    anno_file = 'training_data/wider_face/wider_face_train_bbx_gt.txt'
    im_dir = 'training_data/wider_face/images'
    save_dir = './training_data/24'
    
    model_path = '../models/PNet/PNet-30'
