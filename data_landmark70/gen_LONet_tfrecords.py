...
if __name__ == '__main__': 
    ...
    anno_file = os.path.join(root_dir, '../data_landmark98/training_data/wider_face/wider_face_train_bbx_gt.txt')
    im_dir = os.path.join(root_dir, '../data_landmark98/training_data/wider_face/images')
    landmark_txt = os.path.join(root_dir, '../data_landmark98/training_data/landmarks_5/trainImageList.txt')
    animoji_txt = os.path.join(root_dir, '../data_landmark98/training_data/landmarks_70/ImageList_8874.txt')
    ...
    save_dir = os.path.join(root_dir, 'training_data/wflw_70_L94')
    tfrecords_output_dir = os.path.join(root_dir, 'training_data/wflw_70_L94/imglists/LONet')              
