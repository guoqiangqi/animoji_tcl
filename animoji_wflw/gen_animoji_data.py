...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.realpath(__file__)),'../core_wflw'))
...
if __name__ == '__main__':
    ...
    model_path = [os.path.join(root_dir, '../models/PNet_1/PNet-60'), 
                  ...
                  os.path.join(root_dir, '../models/LONet_wflw_finetune/LONet-1661')]
    image_txt = os.path.join(root_dir, '../data/training_data/landmarks_70/ImageList_wflw.txt')              
    file_path='LONet_wflw_finetune/LONet-1661'              
    ...
    out_data_dir = os.path.join(root_dir,file_path,'tmp')
    ...
    for i, line in enumerate(lines):
        ...
        try:
            _, _, boxes_pred,animoji_pred, _ = facenet.predict(image)
        except Exception:
            print('\n -------error happend------ ')
        ...
        np.savez(savez_path,bbox=bbox,landmark=landmark,boxes_pred=boxes_pred,animoji_pred=animoji_pred)
    ...
    f = open(os.path.join(root_dir,file_path,'detect_result.txt'), 'w')
